...
Elements.navFitcherButton.on("click", function (e) {
    (0, _cssHelpers.clearBikeContextAndRenderText)(text1.featuresOfBike);
});

Elements.navSizeButton.on("click", function (e) {
    (0, _cssHelpers.clearBikeContextAndRenderText)(text1.sizeCalculator);

    var inseam = (0, _jquery2.default)("#selectInseam");
    var height = (0, _jquery2.default)("#selectHeight");
    var renderBikeSize = (0, _jquery2.default)("#renderSize");
    _size.SizeCalculator.renderSelectOptions(height, 150, 192);
    _size.SizeCalculator.renderSelectOptions(inseam, 61, 73);
    height.on("change", function (e) {
        inseam.text("");
        var range = _size.SizeCalculator.calculateInseamRange(height.val());
        _size.SizeCalculator.renderSelectOptions(inseam, range.min, range.max);
    });
    var calculatorButton = (0, _jquery2.default)("#calculate");
    calculatorButton.on("click", function (e) {
        e.preventDefault();
        var sizes = _size.SizeCalculator.calculateSizeBike(height.val(), inseam.val());
        renderBikeSize.text("");

        _size.SizeCalculator.renderSizeBike(sizes, renderBikeSize);
    });
});
...
Elements.navBikesButton.on("click", function (e) {
    ...
    _http.Http.fetchDataBikes(url).then(function (data) {
        ...
        data.forEach(function (bike) {
            allBikes.push(new _bikes.Bike(bike.Brand, bike.Model, bike.Type, bike.Spec.Tires.size, bike.fullname));
        });
...
function FetchAndEventBikeInfo(url) {
    (0, _jquery2.default)(".bikeInfo").on("click", function (e) {
        ...
        _http.Http.fetchDataInfo(url, value).then(function (data) {
            ...
            (0, _jquery2.default)(".tumb").on("click", function (e) {
                (0, _jquery2.default)("#main-img-bike").attr("src", '' + e.currentTarget.attributes[1].value);
            });
        });
    });
}
...
var typeText = exports.typeText = "\n  <div class=\"container\" id=\"typeText\">\n    <section class=\"text-center \">\n        <h2>How  to choose bike type</h2>\n            <img class=\"img-fluid\" src=\"Images/New_Riders_on_Bikes_1853006169.jpg\" alt=\"riders on bikes\" width=\"900px\" hight=\"600px\">\n           \n\n        <article></article>   \n            <h3>Road Bikes</h3>\n            <p>\n            Road bikes are good for multiple pavement uses including fitness riding, commuting, long-distance/event rides, touring and racing. They usually have lightweight drop-bar handlebars that curve downward, putting you in an aerodynamic position, making them a good choice if you want to go fast or are most concerned with efficiently transferring your energy into making the bike move forward. They also allow for a greater number of riding and hand positions than bikes with flat bars. Their more aerodynamic riding position (bent over at the waist) may put more strain on your back if you are less flexible.\n            </p>\n            <img class=\"img-fluid\" src=\"Images/specialized-venge-pro-20191.jpg\" alt=\"Rode Bike\" max-width=\"900px\" max-hight=\"600px\"  >\n            <p>Road bikes have some specialized categories:</p>\n            <p>\n                    <b>Racing bikes:</b> These light and aerodynamic bikes are built for going fast on the flats and charging up hills on race day or during a group ride with friends. Their frames are usually made from carbon fiber or aluminum and they have a slimmed-down design that\u2019s intended to be as light as possible. Racing bikes generally have an aggressive geometry with steep angles that make them turn quickly.\n            </p>\n           \n            <p>\n                    <b>Endurance bikes:</b> Endurance bikes have many of the performance features of racing bikes, but with a frame geometry that puts you in a more comfortable riding position. They generally have taller head tubes, slacker (lower) angles and sloping top tubes intended to reduce stress on your back and neck. They also often feature clearance for larger width tires for versatility and a softer, more comfortable ride. Some endurance bikes have flat handlebars, for those who prefer a more heads-up riding style. \n            </p>\n            <img class=\"img-fluid\" src=\"Images/classic_touring_bike-1462899249635-ds181033h2kx-1000-90.jpg\" alt=\"turning bike\" width=\"900px\" hight=\"600px\" >\n            <p>\n                    <b>Cyclocross bikes:</b> Cyclocross bikes are lightweight, yet tough enough to deal with the extreme conditions of cyclocross racing (which involves riders taking laps around courses that may feature pavement, dirt trails and grass). Most cyclocross bikes have semi-knobby tires to handle the terrain challenges.\n            </p>\n            <p>\n                    <b>Touring Bikes:</b> Touring bikes have a few tweaks on the traditional road bike design that make them ideal for long-distance bike tours. They are designed with sturdy frames capable of carrying heavy loads on front and rear racks and feature multiple attachment points so you can attach racks, fenders, water bottles, pumps, lights and more. Many touring bikes have a longer wheelbase (the distance between the two wheel hubs) than other road bikes and they tend to have a lower center of gravity, which makes them easier to control. Many touring bikes also have disc brakes for improved stopping power while hauling heavy loads on non-paved surfaces.\n            </p>\n            <a href=\"#\">Explore Road Bikes</a>\n        </article>\n        <article class=\"art\">\n            <h3 >Mountain bikes</h3>\n            <p>Designed with shock-absorbing features and better braking systems, mountain bikes can handle dirt trails and the rocks, roots, bumps and ruts that come with them. They usually feature lower gears than most road bikes to better handle steeper terrain.</p>\n          \n            <img class=\"img-fluid\" src=\"Images/norco-1-601x400.jpg\" alt=\"Turning bike\" width=\"900px\" , height=\"600px\">\n            \n            <p>There are several categories of mountain bikes:</p>\n            \n            <p><b>Trail Bikes:</b> This is arguably the most common mountain biking style because the category isn\u2019t grounded in any specific type of racing. If you\u2019re interested in meeting up with friends at the local trailhead and riding a mixture of climbs and descents, then this is the style for you. Bikes in this category place equal emphasis on fun, efficiency and sensible overall weight.\n            Typical specs: 120\u2013140mm of suspension travel; 67\u201369\xB0 head-tube angle</p>\n            \n            <img class=\"img-fluid\" src=\"Images/DSC9539.jpg\" alt=\"Turning bike\" width=\"900px\" , height=\"600px\">\n            <p> <b>Cross-Country Bikes:</b> This style of riding typically implies riding fast, with an emphasis on climbing prowess. Distances vary from just a few miles to 25-plus, and bikes tend to focus on efficiency and low weight. These bikes can be great if you\u2019re considering getting competitive or would like a racier ride for your local trails.\n            Typical specs: 80\u2013100mm of suspension travel; 70\u201371\xB0 head-tube angle</p>\n            \n            <p><b> Downhill/Park Mountain Bikes:</b> Mostly ridden at lift-serviced bike parks, these bikes aren\u2019t sold by REI. Downhill bikes are big and tough, and riders wear full-face helmets and body armor as they encounter jumps,berms, rock gardens and wooden ladders.  Typical specs: 170\u2013200+mm of suspension travel; 63\u201365\xB0 head-tube angle.</p>        \n        </article>\n        <article>\n            <h3 >Hibrid Bikes</h3>\n            <p>A mix of mountain, road, and touring designs, hybrid bikes mash up specific features to create do-it-all bikes with a wide range of uses. Generally, you\u2019ll get the skinny, speedy wheels of road bikes mixed in with the quick-turning prowess of mountain bikes, plus a dash of comfort with a plush saddle or even a shock-absorbent fork. They usually combine a flat bar and a heads-up ride for comfort and a better view when riding in traffic. Some hybrid bikes are equipped with disc brakes for responsive braking while bike commuting in any weather. Many commuter-friendly models include racks, lighting systems or fenders.\n             No two hybrid bikes are exactly the same, so look for a bike equipped with features that make it suited to the type of riding you plan to do.</p>\n             <img class=\"img-fluid\" src=\"Images/Best-Hybird-bikes-under-1000.jpg\" alt=\"Turning bike\" width=\"900px\" , height=\"600px\">\n             \n             <p> Specialty bikes have very specific features and end uses that set them apart from other bikes we sell. Specialty bikes include cruiser bikes, cargo bikes, electric bikes and folding bikes.</p>\n            \n             <p><b>Cruiser bikes:</b> Cruiser bikes are built for leisurely rides around town. Many of them feature slightly wider 26-inch tires than other pavement bikes, a comfortable seat and a relaxed sitting position. Some cruiser bikes even have internally geared rear hubs for easy maintenance.</p>\n            \n             <p><b>Cargo bikes:</b> With stout frame designs that are built for stowing gear and carrying lots of weight, cargo bikes make it easy to run errands and transport kids. While they tend to be heavier and slower than other types of bikes, their utility makes them popular for urban cycling.</p>\n             <img class=\"img-fluid\" src=\"Images/Pedego-Ridge-Rider-electric-bike-1.jpg\" alt=\"Turning bike\" width=\"900px\" , height=\"600px\">\n             \n             <p><b>Electric bikes:</b> Electric bikes feature a battery-powered motor that can help you climb hills easily or make your commute less strenuous. Built-in sensors can monitor how much pressure you're putting on the pedals and then apply battery power accordingly.</p>\n             <br>\n             <p><b>Folding bikes:</b> These bikes can be folded up and placed in a carrying bag, which makes them handy for commuters with limited storage space at home or the office. They are lightweight yet strong and can be folded up quickly and easily. Folding bikes are also a good choice for those who want to travel with their bike.</p>\n        </article>\n\n    </section> </div>";
...
exports.bikeInfo = exports.asideNav = exports.sortButton = exports.bikeContext = exports.types = exports.features = exports.filterManu = exports.mainContext = exports.navSizeButton = exports.navBikesButton = exports.navFitcherButton = exports.navTypeButton = undefined;
...
exports.search = exports.searchButton = exports.C650 = exports.C700 = exports.er27 = exports.er29 = exports.focus = exports.trek = exports.cube = exports.scott = exports.hibrid = exports.mountain = exports.road = undefined;
...
var road = exports.road = (0, _jquery2.default)("#road");
var mountain = exports.mountain = (0, _jquery2.default)("#mountain");
var hibrid = exports.hibrid = (0, _jquery2.default)("#hibrid");
var scott = exports.scott = (0, _jquery2.default)("#scott");
var cube = exports.cube = (0, _jquery2.default)("#cube");
...
var SizeCalculator = exports.SizeCalculator = function () {
    function SizeCalculator() {
        _classCallCheck(this, SizeCalculator);
    }

    _createClass(SizeCalculator, null, [{
        key: "renderSelectOptions",
        value: function renderSelectOptions(element, min, max) {
            var i = min;
            element.append("<option value=\"" + i + "\">" + i + "cm or smaller<option>"), i++;
            for (i; i < max; i++) {
        ...
        key: "calculateInseamRange",
        value: function calculateInseamRange() {
            var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 150;
        ...
        key: "calculateSizeBike",
        value: function calculateSizeBike(height, inseam) {
            var sizebike = {
                MountHibrid: {
                    inches: "",
                    size: ""
        ...
        key: "renderSizeBike",
        value: function renderSizeBike(sizebikes, element) {
...
var RenderText = exports.RenderText = function () {
    function RenderText() {
    ...
    _createClass(RenderText, [{
        ...
        /*#region featuresOfBikes-Parts*/

    }, {
        key: "gears",
        value: function gears() {
            return "<div class=\"container\" id=\"FeaturesText\">\n             <section class=\"text-center\">\n\n             <h2>\n              How to choose bycicle fitchers\n             </h2>\n\n              <article class=\"row\">\n              <h3 class=\"col-sm-12\">\n              Gears\n              </h3>\n\n              <img class=\"col-sm-12 col-lg-6\"\n               src=\"Images/Road-bike-gears-820x360.jpg\"\n               alt=\"bycicle gears\">\n       \n              <p class=\"col-sm-12 col-lg-6\">\n              <b class=\"heading-start\">Gears</b>\n               If your last bike was a 10-speed, then you may be surprised to learn that today's bikes commonly come with 18, 21, 24 or even 27 gears. When you factor in the many combinations of multiple chainrings and cogs and the numbers of teeth on them, things can get complex.\n\n               To keep it simple, the most important things to consider are your fitness level and the terrain you'll be riding. If you'll be riding lots of hills and you find climbing challenging, then you'll want to opt for more gears.\n           \n               If you're a strong cyclist or you only ride flat terrain, you won't need as many low gears to power up a hill so you can get away with fewer gears, which will keep your bike light. Some hybrid bikes have only one speed, and are aptly named single-speed bikes. These bikes have a freewheel mechanism in the rear hub that allows you to coast just like you would on a standard bike with multiple gears.\n           \n               Learn more about bike gears in our Bike Gears and Shifting Basics article.\n               </p>\n\n               </article>";
        }
    }, {
        key: "wheelSize",
        value: function wheelSize() {
            return "  <article class=\"row\">\n\n                   <h3 class=\"col-sm-12\">\n                   Wheel Size\n                   </h3>\n\n                   <p class=\"col-sm-12 col-lg-6\">\n\n                   <b class=\"heading-start\">Wheel Size:</b> <b>700c:</b>\n                    This is the standard size wheel found on almost every road bike and hybrid bike. Don\u2019t worry too much about wheel size on a road bike unless you\u2019re smaller in stature and have had trouble finding the right fit on a bike, in which case you may want to look for a bike with smaller 650c wheels. <br>\n\n                    <b>650c:</b>\n                      A handful of road bikes are designed for smaller 650c wheels. If you\u2019re shorter than about 5 ft. 4 in. and have had trouble finding the right fit on a road bike with 700c wheels, you may want to try a bike with 650c wheels.\n                       <br>\n        \n                      <b>26 in.:</b>\n                       In the not-too-distant past, all adult mountain bikes were equipped with 26 in. wheels. It still is an available wheel size, but now when you walk into a bike shop and inquire about mountain bikes, you are likely to be asked, \u201C27.5 in. or 29 in.?\u201D \n                       <br>\n        \n                      <b>27.5 in.</b>\n                       (also known as 650b): Offering a middle ground between standard 26 in. wheels and 29ers, this wheel size applies a \u201Cbest of both worlds\u201D solution, more easily rolling over terrain than the 26s, but more maneuverable than 29ers.\n                       </p> \n                       <br>\n\n                       <img class=\" gears col-sm-12 col-lg-6 img-clear\" src=\"Images/650B-wheel-size-comparison02.jpg\" \n                        alt=\"wheel sizes\">\n\n                       <p class=\"col-sm-12\">\n                       <b>29ers:</b>\n                         These bikes feature 29 in. wheels that are a little slower to accelerate, but once you start moving you can conquer considerably more terrain far easier than on a bike with 26 in. wheels. They are more efficient for longer rides as they keep their momentum up and they have a higher \u201Cattack angle,\u201D meaning the wheel rolls over trail obstacles easier. These bikes have become extremely popular for the cross-country crowd. 29ers can be found in rigid, hardtail and full-suspension rigs.\n         \n                              \n                         <b>24 in.:</b>\n                           Many kids\u2019 bikes have 24 in. wheels to accommodate the shorter legs of children. Most are less-expensive versions of adult bikes with simpler components. Generally speaking, these suit kids ages 10 to 13, but this depends more on the size of the child than the age. Younger/smaller children can get started on mountain bikes with 20 in. wheels.\n        \n                         <b>20 in.:</b>\n                           This wheels size is found on some BMX and folding bikes and is also common on kids\u2019 bikes.\n        \n                         <b>16 in. and 12 in.:</b>  \n                         These wheel sizes are found on bikes for young kids. 16 in. wheels are often accompanied by training wheels and 12 in. wheels are common on balance bikes for real young riders.\n                         </p>\n                         </article>";
        }
    }, {
        key: "bikeSuspension",
        value: function bikeSuspension() {
        ...
        key: "sizeCalculatorInfo",
        value: function sizeCalculatorInfo() {
            return "<div class=\"container\">\n                 <div class=\"col-lg-12\">\n                 <h2 class=\"text-center\">\n                 Clalculate Bicycle Size\n                 </h2>\n\n                 </div>\n\n                 <div class=\"col-lg-12 row\">\n                 <div class=\"col-lg-6\">\n\n                 <ol>\n                    <li>\n                       Be sure of the type of bicycle you want: Mountain bike, city bike or road bike. You can\n                       read about the different bike types\n                    </li>\n                     <li>\n                     Take off your shoes and stand with your legs about 15-20 cm(6\u201D \u2013 8\u201D) apart. Measure the\n                     height from the ground to your crotch. (B)\n                     </li>\n                      <li>\n                      Take off your shoes and stand with your legs about 15-20 cm(6\u201D \u2013 8\u201D) apart. Measure the\n                      height form the ground to top of your head. (A)\n                      </li>\n                     <li>\n                      To choose a size you should stand over the frame with both feet flat on the ground. A\n                      properly sized bike frame will have 5cm(2\") clearance between the top tube of the frame\n                      and your crotch. (C)\n                     </li>\n                 </ol>\n                 </div>\n      \n                 <img class=\"col-lg-6\" src=\"Images/shema-bikeman.gif\" alt=\"How to calculate size\">\n                 </div>";
        }
    }, {
